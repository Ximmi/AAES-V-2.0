...
create table Menu(idMe int(3) auto_increment primary key, entrada varchar(20), principal varchar(20), postre varchar(20), bebidas varchar(20) );
...
create table OtrosServicios(idProd int(4) auto_increment primary key, nombre varchar(50), precio float(6), descripcion varchar(50));
...
delimiter //
create procedure AgregarMenu(ent varchar(20),  prin varchar(20), pos varchar(20), beb varchar(20) )
begin
insert into Menu(entrada, principal, postre, bebidas) values (ent, prin, pos, beb);
end //
delimiter ;
...
drop procedure if exists AgregarOS;
delimiter //
create procedure AgregarOS(nom varchar(50), pres float(6), descr varchar(50))
begin
insert into OtrosServicios(nombre, precio, descripcion) values (nom, pres, descr);
end //
delimiter ;
...
call AgregarMenu('ensalada', 'pavo', 'pastel', 'vino');
call AgregarMenu('sopa', 'res', 'fruta en almivar', 'Agua');
call AgregarMenu('fruta', 'huevo', 'yougurt', 'jugo');
